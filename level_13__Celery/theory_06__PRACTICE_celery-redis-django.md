...
4. Запускаем выполнение задачи синхронно [http://127.0.0.1:8000/run-task/](http://127.0.0.1:8000/run-task/)
   * Через 10 сек ожидания видим JSON
   ```json
    ...
    ```
5. Даём команду на асинхронное исполнение задачи [http://127.0.0.1:8000/run-task-async/](http://127.0.0.1:8000/run-task-async/)
...
6. Чтобы увидеть результат делаем новый запрос: [http://127.0.0.1:8000/task-status/task_id/](http://127.0.0.1:8000/task-status/task_id/)
   * Вместо `task_id` необходимо подставить id из предыдущего ответа: [http://127.0.0.1:8000/task-status/72e70c61-6e25-4d61-829d-c6cb30a30a31/](http://127.0.0.1:8000/task-status/72e70c61-6e25-4d61-829d-c6cb30a30a31/)
